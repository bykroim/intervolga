        ...
        <tr>
            <td style="padding-top: 11px;">
							...
							<div class="hd_loginform">
								<span class="hd_title_loginform"><?$APPLICATION->IncludeComponent(
                                        "bitrix:main.include",
                                        "",
                                        Array(
                                            "AREA_FILE_SHOW" => "file",
                ...
                <a href="" class="hd_signup"><?$APPLICATION->IncludeComponent(
                        "bitrix:main.include",
                        "",
                        Array(
                            "AREA_FILE_SHOW" => "file",
